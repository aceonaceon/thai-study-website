    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <article>
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">關於學無界</h1>
        </header>

        <div className="prose max-w-none mb-8">
          <h2>學無界 Study Without Borders</h2>
          <p>
          ...
          <ul>
            <li>
              <strong>18 年專業經驗</strong>：深耕留學代辦領域，熟悉各國教育體系與申請流程
            </li>
            <li>
              <strong>超過 1,000 位成功案例</strong>：累積豐富的實戰經驗，能精準評估學生需求
            </li>
            <li>
              <strong>一站式服務</strong>：從選校、申請、簽證到住宿，全程協助
            </li>
            <li>
              <strong>透明收費</strong>：費用清楚透明，無隱藏成本
            </li>
            <li>
              <strong>持續追蹤</strong>：學生入學後仍提供生活適應諮詢
            </li>
          </ul>
          ...
          <ul>
            <li>泰國大學申請（朱拉隆功、法政、易三倉等）</li>
            <li>國際學程諮詢（學士、碩士、博士）</li>
            <li>國際學校入學協助（IB/AP/A-Level）</li>
            <li>夏令營規劃與報名</li>
            <li>學生簽證代辦</li>
            <li>住宿安排建議</li>
          </ul>

          <h2>創辦人 Jason Huang</h2>
          <p>
          ...
          <ul>
            <li>
              ...
              <a href="https://lin.ee/Tx17iiE" target="_blank" rel="noopener noreferrer">
                https://lin.ee/Tx17iiE
              </a>
            </li>
            <li>
              <strong>官方網站</strong>：
              <a href="https://studywb.com" target="_blank" rel="noopener noreferrer">
                https://studywb.com
              </a>
            </li>
          </ul>
