    ...
    <footer className="footer">
      <div className="footer__container">
        <div className="footer__grid">
          {/* Column 1: 關於學無界 */}
          <div>
            <h3 className="footer__title">關於學無界</h3>
          ...
          {/* Column 3: 聯絡資訊 */}
          <div>
            <h3 className="footer__title">聯絡資訊</h3>
            <ul>
              <li>
                <a
              ...
              <li>
                <a
                  href="mailto:service@studywb.com"
                  className="footer__link"
                >
          ...
          {/* Column 4: 社群媒體 */}
          <div>
            <h3 className="footer__title">社群媒體</h3>
            <div className="footer__social">
              {/* Facebook */}
              <a
                href="https://facebook.com/studywb"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Instagram */}
              <a
                href="https://instagram.com/studywb"
                target="_blank"
                rel="noopener noreferrer"
                className="footer__social-icon"
